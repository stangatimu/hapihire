...
3. If I could include authenication, I would make the comment section would be realist be having just the comments' text input and get rid of the dummy recruiter field name.
